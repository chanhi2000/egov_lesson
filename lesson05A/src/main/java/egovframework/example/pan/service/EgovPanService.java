...
public interface EgovPanService {
     ...
     * @exception Exception
     */
    int updatePan(PanVO vo) throws Exception;
     ...
     * @exception Exception
     */
    int deletePan(PanVO vo) throws Exception;
     ...
     * @exception Exception
     */
    List<?> selectPanList(SampleDefaultVO searchVO) throws Exception;
     ...
     * @exception
     */
    int selectPanListTotCnt(SampleDefaultVO searchVO);
